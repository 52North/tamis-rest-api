...
/**
 * Class to delegate a processes overview request to the WPS proxy.
 * 
 * @author Christian Danowski (contact: c.danowski@52north.org)
 *
 */
public class ProcessesRequestForwarder extends AbstractRequestForwarder {
	...
	protected String setUpTargetUrl_WithSameBaseUrl(String contextURL) {
		 ...
		 * 
		 * contexURL: "<baseURL>/constantServicePrefix/{service_id}/processes"
		 * 
		 * targetURL: "<baseURL>/processes"
		 */

		String targetURL = contextURL.split(URL_Constants_TAMIS.TAMIS_PREFIX)[0];
		targetURL = targetURL + URL_Constants_WpsProxy.SLASH_PROCESSES;
	...
	protected String setUpTargetUrl_WithDifferentBaseUrl(String baseURL_WpsProxy) {
		return baseURL_WpsProxy + URL_Constants_WpsProxy.PROCESSES;
	}
