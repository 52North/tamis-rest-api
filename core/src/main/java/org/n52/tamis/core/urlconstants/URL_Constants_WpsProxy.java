...
public class URL_Constants_WpsProxy {
	...
	public static final String EXECUTE = PROCESS_DESCRIPTION_SINGLE + SLASH_JOBS;
	
	public static final String EXECUTE_ASYNCHRONOUS = PROCESS_DESCRIPTION_SINGLE + SLASH_JOBS + SYNC_EXECUTE_FALSE;

	public static final String EXECUTE_SYNCHRONOUS = PROCESS_DESCRIPTION_SINGLE + SLASH_JOBS + SYNC_EXECUTE_TRUE;
