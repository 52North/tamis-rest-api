...
/**
 * Specialization that adds a TAMIS-project specific prefix to the URLs.
 * 
 * @author Christian Danowski (contact: c.danowski@52north.org)
 *
 */
public class URL_Constants_TAMIS extends URL_Constants_WpsProxy {
	...
	/*
	 * TAMIS_PREFIX is specifically for TAMIS REST Binding
	 */
	public static final String TAMIS_PREFIX = "services";
	...
	public static final String CAPABILITIES = API_V1_BASE_PREFIX + "/" + TAMIS_PREFIX + "/" + SERVICE_ID_VARIABLE_NAME_WITH_BRACES;
	...
	public static String getCapabilitiesURL(String serviceId) {
		return API_V1_BASE_PREFIX + "/" + TAMIS_PREFIX + "/" + serviceId;
	}
}
